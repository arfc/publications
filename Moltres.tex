...
\label{eq:neutrons}
        \intertext{where}
        v_g &= \mbox{speed of neutrons in group g } [<+units+>]\\ 
        \phi_g &= \mbox{flux of neutrons in group g } [<+units+>]\\ 
        t &= \mbox{time } [<+units+>]\\ 
        D_g &= \mbox{Diffusion coefficient for neutrons in group g } [<+units+>]\\ 
        \Sigma_g^r &= \mbox{macroscopic cross-section for removal of neutrons 
        from group g } [<+units+>]\\ 
        \Sigma_{g'\rightarrow g} &= \mbox{macroscopic cross-section of 
        scattering from g' to g } [<+units+>]\\ 
        \chi_g^p &= \mbox{prompt fission spectrum, neutrons in group g } [<+units+>]\\ 
        G &= \mbox{number of discrete groups, g } [<+units+>]\\ 
        \nu &= \mbox{number of neutrons produced per fission } [<+units+>]\\ 
        \Sigma_g^f &= \mbox{macroscopic cross section for fission due to neutrons in group g } [<+units+>]\\ 
        \chi_g^d &= \mbox{delayed fission spectrum, neutrons in group g } [<+units+>]\\ 
        I &= \mbox{number of delayed neutron precursor groups } [<+units+>]\\ 
        \lambda_i &= \mbox{average decay constant of delayed neutron precursors 
        in precursor group i } [<+units+>]\\ 
