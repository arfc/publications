...
\Cref{fig:flux_comparison} compares the fast and thermal neutron fluxes at the
reactor mid-plane ($z=H/2$). Local thermal flux growth and fast flux decay in
moderator regions and visa versa in fuel regions are even more apparent. The
larger fast flux magnitude is attributable to using \gls{BOL} fuel
composition. As the fuel salt reaches an equilibrium composition, the thermal
flux is expected to exceed that of the fast group.

\begin{figure}[htpb]
  \centering
  \includegraphics{radial_group_comparison.eps}
  \caption{The thermal and fast flux profiles are compared at the core mid-plane
    ($z=H/2$) in this 2-D cylindrical axisymmetric model ($r=0$ is radial center
    of core). }
...
\begin{figure}[htpb]
  \centering
  \includegraphics{2d_gamma_heating_pre1.eps}
...
\begin{figure}[htpb]
  \centering
  \includegraphics{2d_gamma_heating_pre6.eps}
...
\begin{figure}[htpb]
  \centering
  \includegraphics{fuel_vs_moderator_axial_sweep.eps}
        \caption{Moltres predicted axial temperature profiles near r = 0}
  \label{fig:moltres_axial_temps}
\end{figure}

\begin{figure}[htpb]
  \centering
  \includegraphics{msre_axial_temps.png}
        \caption{\gls{MSRE} design axial temperature profiles near r = 0}
  \label{fig:msre_axial_temps}
\end{figure}

\begin{figure}[htpb]
  \centering
  \includegraphics[width=\maxwidth{\textwidth}]{fast_vs_thermal_nt_flux_msre.png}
  \caption{\gls{MSRE} design radial temperature profiles at reactor mid-plane}
  \label{fig:msre_radial_temps}
\end{figure}
