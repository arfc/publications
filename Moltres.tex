...
\cite{briggs_molten-salt_1964} along the reactor center-line (r = 0).
...
\begin{figure}[htpb]
  ...
  \caption{\gls{MSRE} design radial flux profiles at reactor mid-plane
    \cite{briggs_molten-salt_1964}}
...
\begin{figure}[htpb]
  ...
  \caption{\gls{MSRE} design axial flux profiles at r = 0
    \cite{briggs_molten-salt_1964}}
