...
inventories and spent nuclear fuel mass \cite{noauthor_gen_2008}.  
Due to these characteristics give the \gls{MSR} potentially unique 
capabilities burning actinides and extending fuel resources.
...
cause the depression in the thermal flux in \cref{fig:msre_radial_fluxes}.
...
Moltres and the \gls{ORNL} \gls{MSRE} design model. The radius for the
