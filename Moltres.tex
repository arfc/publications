...
\cite{lindsayad_arfc/moltres_nodate}, for \gls{MSR} simulation. Moltres is an
open source code licensed under LGPL2 terms that aims to be a tool that can be
...
top of the \gls{MOOSE} framework, \cite{gaston_physics-based_2015} another LGPL
code that itself leans on LibMesh \cite{kirk2006libmesh}, a LGPL finite element
library, and PetSc \cite{petsc-user-ref}, a BSD toolkit for solving nonlinear
equations stemming from discretization of PDEs. MOOSE and LibMesh handle
...
on massively-parallel cluster-computing platforms. MOOSE applications by default
