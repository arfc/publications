...
to restrict openness of software that is dual use, Moltres requires that 
cross sections be provided by the user, is tailored to molten salt reactor 
physics, and joins a veritable parade of open academic nuclear engineering
software such as OpenMC\cite{romano_openmc:_2015}, OpenMOC\cite{boyd_openmoc_2014}, and 
