...
The sum of the aforementioned benefits imply spent nuclear fuel
mass can be reduced in comparison to legacy reactors.
Due to these characteristics, the \gls{MSR} is potentially uniquely capable of 
extending fuel resources and ameliorating spent fuel burden.
