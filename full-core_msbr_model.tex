...
The molten salt reactor (MSR) is advanced type of reactor which was  developed in Oak Ridge National Laboratory for a military aircraft nuclear propulsion project. In the MSR flourides of fissile and/or ferile materials (i.e. $UF_4$, $PuF_3$ and/or $ThF_4$) are mixed with carrier salts to form liquid fuel. 
combining two functions: heat transportation from the energy generation region  to heat exchanger and 
