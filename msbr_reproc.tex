...
\begin{figure}[htbp!] % replace 't' with 'b' to force it to be on the bottom
        \centering
        \includegraphics[width=0.95\linewidth]{zone_I_mesh.png}
        \caption{MoltenSalt Breeder Reactor (MSBR) unit cell of Zone I geometry.}
        \label{fig:zoneI}
\end{figure}
...
Standard deviation for these calculations is approximately 100 pcm. Figure~\ref{fig:keff} 
...
\begin{figure}[htbp!] % replace 't' with 'b' to force it to be on the bottom
        \centering
        \includegraphics[width=1.04\linewidth]{fuel_composition.png}
...
\begin{figure}[htbp!] % replace 't' with 'b' to force it to be on the bottom
        \centering
        \includegraphics[width=1.04\linewidth]{rates_fuel.png}
...
\begin{figure}[htbp!] % replace 't' with 'b' to force it to be on the bottom
        \centering
        \includegraphics[width=1.04\linewidth]{rates_outflow.png}
...
\begin{figure}[htbp!] % replace 't' with 'b' to force it to be on the bottom
        \centering
        \includegraphics[width=1.05\linewidth]{spectrum.png}
        \caption{Neutron spectrum for initial and equilibrium 
        composition (normalized per lethargy).}
        \label{fig:spectrum}
\end{figure}
