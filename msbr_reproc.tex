...
Recently, interest in \glspl{MSR} is resurgent, with multiple new companies 
...
strategies for online reprocessing and refueling, advanced
computational analysis methods capturing
their unique reactor physics and process chemistry are needed.
Most contemporary nuclear reactor physics software is unable
to perform depletion calculations in an online reprocessing 
regime. Powers \emph{et al.} suggested a novel method to conducting 
...
al.} to find an equilibrium fuel composition for \gls{MSBR} and to validate it 
with an \gls{MCNP}/CINDER90 
model \cite{jeong_equilibrium_2016}. 
